        ...
        <div className="fundo">
            ...
            <div className="main-table">
                <section className="table-body">
                    ...
                    <dialog>
                       <p>VOCÊ ESTÁ PRESTES A DELETAR UMA ORDEM DE SERVIÇO, DESEJA CONFIRMAR?</p>
                       <button className="sim">SIM</button>
                       <button className="nao">NÃO</button>
                    </dialog>
                <a href="/abrirChamado" className="button-input">Abrir novo chamado</a>
                <a href="FAQ"><button className="button-input">Perguntas Frequentes</button></a>
            </div>
        </div>
    </main>
